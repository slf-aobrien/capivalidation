...
// ResponseWrapperPolicyDTO ResponseWrapper«PolicyDTO»
//
// swagger:model ResponseWrapper«PolicyDTO»
type ResponseWrapperPolicyDTO struct {
	...
	// payload
	Payload *PolicyDTORes `json:"payload,omitempty"`
...
// Validate validates this response wrapper policy d t o
func (m *ResponseWrapperPolicyDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPolicyDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicyDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicyDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper policy d t o based on the context it is used
func (m *ResponseWrapperPolicyDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPolicyDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicyDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicyDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicyDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperPolicyDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperPolicyDTO
