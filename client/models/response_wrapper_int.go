...
// ResponseWrapperInt ResponseWrapper«int»
//
// swagger:model ResponseWrapper«int»
type ResponseWrapperInt struct {
...
// Validate validates this response wrapper int
func (m *ResponseWrapperInt) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperInt) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperInt) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper int based on the context it is used
func (m *ResponseWrapperInt) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperInt) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperInt) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperInt) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperInt) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperInt
