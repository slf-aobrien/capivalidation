...
// ResponseWrapperListPersonDTO ResponseWrapper«List«PersonDTO»»
//
// swagger:model ResponseWrapper«List«PersonDTO»»
type ResponseWrapperListPersonDTO struct {
	...
	// payload
	Payload []*PersonDTORes `json:"payload"`
...
// Validate validates this response wrapper list person d t o
func (m *ResponseWrapperListPersonDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPersonDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list person d t o based on the context it is used
func (m *ResponseWrapperListPersonDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPersonDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListPersonDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListPersonDTO
