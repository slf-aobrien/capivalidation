...
// ResponseWrapperListPortabilityRuleDTO ResponseWrapper«List«PortabilityRuleDTO»»
//
// swagger:model ResponseWrapper«List«PortabilityRuleDTO»»
type ResponseWrapperListPortabilityRuleDTO struct {
	...
	// payload
	Payload []*PortabilityRuleDTO `json:"payload"`
...
// Validate validates this response wrapper list portability rule d t o
func (m *ResponseWrapperListPortabilityRuleDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPortabilityRuleDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPortabilityRuleDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPortabilityRuleDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list portability rule d t o based on the context it is used
func (m *ResponseWrapperListPortabilityRuleDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPortabilityRuleDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPortabilityRuleDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPortabilityRuleDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPortabilityRuleDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListPortabilityRuleDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListPortabilityRuleDTO
