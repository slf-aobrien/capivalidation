...
// ResponseWrapperListDependentDTO ResponseWrapper«List«DependentDTO»»
//
// swagger:model ResponseWrapper«List«DependentDTO»»
type ResponseWrapperListDependentDTO struct {
	...
	// payload
	Payload []*DependentDTORes `json:"payload"`
...
// Validate validates this response wrapper list dependent d t o
func (m *ResponseWrapperListDependentDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListDependentDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListDependentDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListDependentDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list dependent d t o based on the context it is used
func (m *ResponseWrapperListDependentDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListDependentDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListDependentDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListDependentDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListDependentDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListDependentDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListDependentDTO
