...
// ResponseWrapperListBillReconciliationDTO ResponseWrapper«List«BillReconciliationDTO»»
//
// swagger:model ResponseWrapper«List«BillReconciliationDTO»»
type ResponseWrapperListBillReconciliationDTO struct {
	...
	// payload
	Payload []*BillReconciliationDTO `json:"payload"`
...
// Validate validates this response wrapper list bill reconciliation d t o
func (m *ResponseWrapperListBillReconciliationDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillReconciliationDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillReconciliationDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillReconciliationDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list bill reconciliation d t o based on the context it is used
func (m *ResponseWrapperListBillReconciliationDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillReconciliationDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillReconciliationDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillReconciliationDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillReconciliationDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBillReconciliationDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBillReconciliationDTO
