...
// ResponseWrapperDepartmentDTO ResponseWrapper«DepartmentDTO»
//
// swagger:model ResponseWrapper«DepartmentDTO»
type ResponseWrapperDepartmentDTO struct {
	...
	// payload
	Payload *DepartmentDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper department d t o
func (m *ResponseWrapperDepartmentDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperDepartmentDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperDepartmentDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperDepartmentDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper department d t o based on the context it is used
func (m *ResponseWrapperDepartmentDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperDepartmentDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDepartmentDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDepartmentDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDepartmentDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperDepartmentDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperDepartmentDTO
