...
// ResponseWrapperListProcessingRuleDTO ResponseWrapper«List«ProcessingRuleDTO»»
//
// swagger:model ResponseWrapper«List«ProcessingRuleDTO»»
type ResponseWrapperListProcessingRuleDTO struct {
	...
	// payload
	Payload []*ProcessingRuleDTO `json:"payload"`
...
// Validate validates this response wrapper list processing rule d t o
func (m *ResponseWrapperListProcessingRuleDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListProcessingRuleDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListProcessingRuleDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListProcessingRuleDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list processing rule d t o based on the context it is used
func (m *ResponseWrapperListProcessingRuleDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListProcessingRuleDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListProcessingRuleDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListProcessingRuleDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListProcessingRuleDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListProcessingRuleDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListProcessingRuleDTO
