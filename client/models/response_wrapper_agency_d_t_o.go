...
// ResponseWrapperAgencyDTO ResponseWrapper«AgencyDTO»
//
// swagger:model ResponseWrapper«AgencyDTO»
type ResponseWrapperAgencyDTO struct {
	...
	// payload
	Payload *AgencyDTORes `json:"payload,omitempty"`
...
// Validate validates this response wrapper agency d t o
func (m *ResponseWrapperAgencyDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAgencyDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgencyDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgencyDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper agency d t o based on the context it is used
func (m *ResponseWrapperAgencyDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAgencyDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgencyDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgencyDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgencyDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperAgencyDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperAgencyDTO
