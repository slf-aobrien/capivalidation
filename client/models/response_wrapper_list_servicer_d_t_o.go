...
// ResponseWrapperListServicerDTO ResponseWrapper«List«ServicerDTO»»
//
// swagger:model ResponseWrapper«List«ServicerDTO»»
type ResponseWrapperListServicerDTO struct {
	...
	// payload
	Payload []*ServicerDTORes `json:"payload"`
...
// Validate validates this response wrapper list servicer d t o
func (m *ResponseWrapperListServicerDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListServicerDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListServicerDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListServicerDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list servicer d t o based on the context it is used
func (m *ResponseWrapperListServicerDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListServicerDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListServicerDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListServicerDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListServicerDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListServicerDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListServicerDTO
