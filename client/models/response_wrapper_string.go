...
// ResponseWrapperString ResponseWrapper«string»
//
// swagger:model ResponseWrapper«string»
...
func (m *ResponseWrapperString) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperString) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper string based on the context it is used
func (m *ResponseWrapperString) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperString) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperString) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
