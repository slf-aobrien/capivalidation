...
// ResponseWrapperMemberListDTO ResponseWrapper«MemberListDTO»
//
// swagger:model ResponseWrapper«MemberListDTO»
type ResponseWrapperMemberListDTO struct {
	...
	// payload
	Payload *MemberListDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper member list d t o
func (m *ResponseWrapperMemberListDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMemberListDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberListDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberListDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper member list d t o based on the context it is used
func (m *ResponseWrapperMemberListDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMemberListDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberListDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberListDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberListDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperMemberListDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperMemberListDTO
