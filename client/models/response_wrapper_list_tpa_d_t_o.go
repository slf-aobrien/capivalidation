...
// ResponseWrapperListTpaDTO ResponseWrapper«List«TpaDTO»»
//
// swagger:model ResponseWrapper«List«TpaDTO»»
type ResponseWrapperListTpaDTO struct {
...
// Validate validates this response wrapper list tpa d t o
func (m *ResponseWrapperListTpaDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListTpaDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListTpaDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListTpaDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list tpa d t o based on the context it is used
func (m *ResponseWrapperListTpaDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListTpaDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListTpaDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListTpaDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListTpaDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListTpaDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListTpaDTO
