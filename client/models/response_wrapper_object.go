...
func (m *ResponseWrapperObject) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperObject) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper object based on the context it is used
...
func (m *ResponseWrapperObject) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperObject) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
