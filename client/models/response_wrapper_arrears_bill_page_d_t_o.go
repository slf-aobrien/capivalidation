...
// ResponseWrapperArrearsBillPageDTO ResponseWrapper«ArrearsBillPageDTO»
//
// swagger:model ResponseWrapper«ArrearsBillPageDTO»
type ResponseWrapperArrearsBillPageDTO struct {
	...
	// payload
	Payload *ArrearsBillPageDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper arrears bill page d t o
func (m *ResponseWrapperArrearsBillPageDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperArrearsBillPageDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperArrearsBillPageDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperArrearsBillPageDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper arrears bill page d t o based on the context it is used
func (m *ResponseWrapperArrearsBillPageDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperArrearsBillPageDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperArrearsBillPageDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperArrearsBillPageDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperArrearsBillPageDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperArrearsBillPageDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperArrearsBillPageDTO
