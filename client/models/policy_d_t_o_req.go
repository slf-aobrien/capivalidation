...
// PolicyDTOReq PolicyDTOReq
//
// swagger:model PolicyDTOReq
type PolicyDTOReq struct {
	...
	// agent list
	AgentList []*AgentDTOReq `json:"agentList"`
	...
	// bill group list
	BillGroupList []*BillGroupDTOReq `json:"billGroupList"`

	// billing contact list
	BillingContactList []*ContactDTOReq `json:"billingContactList"`
	...
	// install status
	InstallStatus *InstallStatusDTOReq `json:"installStatus,omitempty"`

	// is trust case
	IsTrustCase bool `json:"isTrustCase,omitempty"`
	...
	// member group list
	MemberGroupList []*MemberGroupDTOReq `json:"memberGroupList"`
	...
	PolicyHolderContactList []*ContactDTOReq `json:"policyHolderContactList"`
	...
	PolicyServiceRuleList []*PolicyServiceRuleDTOReq `json:"policyServiceRuleList"`
	...
	// servicer list
	ServicerList []*ServicerDTOReq `json:"servicerList"`
	...
	// tpa contact list
	TpaContactList []*ContactDTOReq `json:"tpaContactList"`
...
// Validate validates this policy d t o req
func (m *PolicyDTOReq) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PolicyDTOReq) validateAddressList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateAgentList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateAssociatedCompanyList(formats strfmt.Registry) error {
...
var policyDTOReqBenefitPackageListItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqBenefitPackageListItemsEnum = append(policyDTOReqBenefitPackageListItemsEnum, v)
	}
}

func (m *PolicyDTOReq) validateBenefitPackageListItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqBenefitPackageListItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateBenefitPackageList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateBillGroupList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateBillingContactList(formats strfmt.Registry) error {
...
var policyDTOReqTypeBillingFrequencyPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqTypeBillingFrequencyPropEnum = append(policyDTOReqTypeBillingFrequencyPropEnum, v)
	}
}

const (

	// PolicyDTOReqBillingFrequencyANNCALENDARDAY captures enum value "ANN_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyANNCALENDARDAY string = "ANN_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyANNNEXTBUSDAY captures enum value "ANN_NEXT_BUS_DAY"
	PolicyDTOReqBillingFrequencyANNNEXTBUSDAY string = "ANN_NEXT_BUS_DAY"

	// PolicyDTOReqBillingFrequencyBIWEEKLYCALENDAR captures enum value "BI_WEEKLY_CALENDAR"
	PolicyDTOReqBillingFrequencyBIWEEKLYCALENDAR string = "BI_WEEKLY_CALENDAR"

	// PolicyDTOReqBillingFrequencyBIWKLYNEXTBUSDAY captures enum value "BI_WKLY_NEXT_BUS_DAY"
	PolicyDTOReqBillingFrequencyBIWKLYNEXTBUSDAY string = "BI_WKLY_NEXT_BUS_DAY"

	// PolicyDTOReqBillingFrequencyDAILYCALENDARDAY captures enum value "DAILY_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyDAILYCALENDARDAY string = "DAILY_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyDAILYNEXTBUSDAY captures enum value "DAILY_NEXT_BUS_DAY"
	PolicyDTOReqBillingFrequencyDAILYNEXTBUSDAY string = "DAILY_NEXT_BUS_DAY"

	// PolicyDTOReqBillingFrequencyFIFTEENTHOFTHEMONTHCALENDARDAY captures enum value "FIFTEENTH_OF_THE_MONTH_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyFIFTEENTHOFTHEMONTHCALENDARDAY string = "FIFTEENTH_OF_THE_MONTH_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyFIRSTDAYOFTHEMONTH captures enum value "FIRST_DAY_OF_THE_MONTH"
	PolicyDTOReqBillingFrequencyFIRSTDAYOFTHEMONTH string = "FIRST_DAY_OF_THE_MONTH"

	// PolicyDTOReqBillingFrequencyLASTDAYOFTHEMONTH captures enum value "LAST_DAY_OF_THE_MONTH"
	PolicyDTOReqBillingFrequencyLASTDAYOFTHEMONTH string = "LAST_DAY_OF_THE_MONTH"

	// PolicyDTOReqBillingFrequencyMOCALENDARDAY captures enum value "MO_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyMOCALENDARDAY string = "MO_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyMOLASTBUSDAY captures enum value "MO_LAST_BUS_DAY"
	PolicyDTOReqBillingFrequencyMOLASTBUSDAY string = "MO_LAST_BUS_DAY"

	// PolicyDTOReqBillingFrequencyMONEXTBUSDAY captures enum value "MO_NEXT_BUS_DAY"
	PolicyDTOReqBillingFrequencyMONEXTBUSDAY string = "MO_NEXT_BUS_DAY"

	// PolicyDTOReqBillingFrequencyQTRLYCALENDARDAY captures enum value "QTRLY_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyQTRLYCALENDARDAY string = "QTRLY_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyQTRLYNEXTBUSDAY captures enum value "QTRLY_NEXT_BUS_DAY"
	PolicyDTOReqBillingFrequencyQTRLYNEXTBUSDAY string = "QTRLY_NEXT_BUS_DAY"

	// PolicyDTOReqBillingFrequencySEMIANNUALCALENDARDAY captures enum value "SEMI_ANNUAL_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencySEMIANNUALCALENDARDAY string = "SEMI_ANNUAL_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencySEMIANNNEXTBUSDAY captures enum value "SEMI_ANN_NEXT_BUS_DAY"
	PolicyDTOReqBillingFrequencySEMIANNNEXTBUSDAY string = "SEMI_ANN_NEXT_BUS_DAY"

	// PolicyDTOReqBillingFrequencySEMIMONTHLY captures enum value "SEMI_MONTHLY"
	PolicyDTOReqBillingFrequencySEMIMONTHLY string = "SEMI_MONTHLY"

	// PolicyDTOReqBillingFrequencySIXTEENTHOFTHEMONTHCALENDARDAY captures enum value "SIXTEENTH_OF_THE_MONTH_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencySIXTEENTHOFTHEMONTHCALENDARDAY string = "SIXTEENTH_OF_THE_MONTH_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyTWENTIETHOFTHEMONTHCALENDARDAY captures enum value "TWENTIETH_OF_THE_MONTH_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyTWENTIETHOFTHEMONTHCALENDARDAY string = "TWENTIETH_OF_THE_MONTH_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyWKLYCALENDARDAY captures enum value "WKLY_CALENDAR_DAY"
	PolicyDTOReqBillingFrequencyWKLYCALENDARDAY string = "WKLY_CALENDAR_DAY"

	// PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYFRI captures enum value "WKLY_NEXT_BUS_DAY_FRI"
	PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYFRI string = "WKLY_NEXT_BUS_DAY_FRI"

	// PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYMON captures enum value "WKLY_NEXT_BUS_DAY_MON"
	PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYMON string = "WKLY_NEXT_BUS_DAY_MON"

	// PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYTHURS captures enum value "WKLY_NEXT_BUS_DAY_THURS"
	PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYTHURS string = "WKLY_NEXT_BUS_DAY_THURS"

	// PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYTUES captures enum value "WKLY_NEXT_BUS_DAY_TUES"
	PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYTUES string = "WKLY_NEXT_BUS_DAY_TUES"

	// PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYWED captures enum value "WKLY_NEXT_BUS_DAY_WED"
	PolicyDTOReqBillingFrequencyWKLYNEXTBUSDAYWED string = "WKLY_NEXT_BUS_DAY_WED"
)

// prop value enum
func (m *PolicyDTOReq) validateBillingFrequencyEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqTypeBillingFrequencyPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateBillingFrequency(formats strfmt.Registry) error {
...
var policyDTOReqTypeBillingTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqTypeBillingTypePropEnum = append(policyDTOReqTypeBillingTypePropEnum, v)
	}
}

const (

	// PolicyDTOReqBillingTypeASOREIMBURSEMENTSREGULAR captures enum value "ASO_REIMBURSEMENTS_REGULAR"
	PolicyDTOReqBillingTypeASOREIMBURSEMENTSREGULAR string = "ASO_REIMBURSEMENTS_REGULAR"

	// PolicyDTOReqBillingTypeCAPPDCOMBINED captures enum value "CA_PPD_COMBINED"
	PolicyDTOReqBillingTypeCAPPDCOMBINED string = "CA_PPD_COMBINED"

	// PolicyDTOReqBillingTypeCAPPDREGULAR captures enum value "CA_PPD_REGULAR"
	PolicyDTOReqBillingTypeCAPPDREGULAR string = "CA_PPD_REGULAR"

	// PolicyDTOReqBillingTypeCOMBINED captures enum value "COMBINED"
	PolicyDTOReqBillingTypeCOMBINED string = "COMBINED"

	// PolicyDTOReqBillingTypeDENTALASOREGULAR captures enum value "DENTAL_ASO_REGULAR"
	PolicyDTOReqBillingTypeDENTALASOREGULAR string = "DENTAL_ASO_REGULAR"

	// PolicyDTOReqBillingTypeHEALTHNAVIGATOR captures enum value "HEALTH_NAVIGATOR"
	PolicyDTOReqBillingTypeHEALTHNAVIGATOR string = "HEALTH_NAVIGATOR"

	// PolicyDTOReqBillingTypeMDBADVANCE captures enum value "MDB_ADVANCE"
	PolicyDTOReqBillingTypeMDBADVANCE string = "MDB_ADVANCE"

	// PolicyDTOReqBillingTypeMDBADVANCECOMBINED captures enum value "MDB_ADVANCE_COMBINED"
	PolicyDTOReqBillingTypeMDBADVANCECOMBINED string = "MDB_ADVANCE_COMBINED"

	// PolicyDTOReqBillingTypeMDBADVANCERECONCILIATION captures enum value "MDB_ADVANCE_RECONCILIATION"
	PolicyDTOReqBillingTypeMDBADVANCERECONCILIATION string = "MDB_ADVANCE_RECONCILIATION"

	// PolicyDTOReqBillingTypeMDBADVANCEREGULAR captures enum value "MDB_ADVANCE_REGULAR"
	PolicyDTOReqBillingTypeMDBADVANCEREGULAR string = "MDB_ADVANCE_REGULAR"

	// PolicyDTOReqBillingTypeMDBARREARS captures enum value "MDB_ARREARS"
	PolicyDTOReqBillingTypeMDBARREARS string = "MDB_ARREARS"

	// PolicyDTOReqBillingTypeMDBARREARSCOMBINED captures enum value "MDB_ARREARS_COMBINED"
	PolicyDTOReqBillingTypeMDBARREARSCOMBINED string = "MDB_ARREARS_COMBINED"

	// PolicyDTOReqBillingTypeMDBARREARSRECONCILIATION captures enum value "MDB_ARREARS_RECONCILIATION"
	PolicyDTOReqBillingTypeMDBARREARSRECONCILIATION string = "MDB_ARREARS_RECONCILIATION"

	// PolicyDTOReqBillingTypeMDBARREARSREGULAR captures enum value "MDB_ARREARS_REGULAR"
	PolicyDTOReqBillingTypeMDBARREARSREGULAR string = "MDB_ARREARS_REGULAR"

	// PolicyDTOReqBillingTypeMONTHLY captures enum value "MONTHLY"
	PolicyDTOReqBillingTypeMONTHLY string = "MONTHLY"

	// PolicyDTOReqBillingTypeNOTIONAL captures enum value "NOTIONAL"
	PolicyDTOReqBillingTypeNOTIONAL string = "NOTIONAL"

	// PolicyDTOReqBillingTypeQUARTERLY captures enum value "QUARTERLY"
	PolicyDTOReqBillingTypeQUARTERLY string = "QUARTERLY"

	// PolicyDTOReqBillingTypeRECONCILIATION captures enum value "RECONCILIATION"
	PolicyDTOReqBillingTypeRECONCILIATION string = "RECONCILIATION"

	// PolicyDTOReqBillingTypeREGULAR captures enum value "REGULAR"
	PolicyDTOReqBillingTypeREGULAR string = "REGULAR"

	// PolicyDTOReqBillingTypeSTOPLOSSANNUALLY captures enum value "STOP_LOSS_ANNUALLY"
	PolicyDTOReqBillingTypeSTOPLOSSANNUALLY string = "STOP_LOSS_ANNUALLY"

	// PolicyDTOReqBillingTypeSTOPLOSSCOMBINED captures enum value "STOP_LOSS_COMBINED"
	PolicyDTOReqBillingTypeSTOPLOSSCOMBINED string = "STOP_LOSS_COMBINED"

	// PolicyDTOReqBillingTypeSTOPLOSSMONTHLY captures enum value "STOP_LOSS_MONTHLY"
	PolicyDTOReqBillingTypeSTOPLOSSMONTHLY string = "STOP_LOSS_MONTHLY"
)

// prop value enum
func (m *PolicyDTOReq) validateBillingTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqTypeBillingTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateBillingType(formats strfmt.Registry) error {
...
var policyDTOReqBillingTypeListItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqBillingTypeListItemsEnum = append(policyDTOReqBillingTypeListItemsEnum, v)
	}
}

func (m *PolicyDTOReq) validateBillingTypeListItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqBillingTypeListItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateBillingTypeList(formats strfmt.Registry) error {
...
var policyDTOReqCommissionPackageListItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqCommissionPackageListItemsEnum = append(policyDTOReqCommissionPackageListItemsEnum, v)
	}
}

func (m *PolicyDTOReq) validateCommissionPackageListItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqCommissionPackageListItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateCommissionPackageList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateCommissionRuleList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateCompensationEntityDTOList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateContact(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateEmailList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateExpenseRuleDTOList(formats strfmt.Registry) error {
...
var policyDTOReqFeePackageListItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqFeePackageListItemsEnum = append(policyDTOReqFeePackageListItemsEnum, v)
	}
}

func (m *PolicyDTOReq) validateFeePackageListItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqFeePackageListItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateFeePackageList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateGroupOfficeList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateInstallStatus(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateMemberGroupList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateNoteList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateOptionChoiceSet(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validatePhoneList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validatePolicyHolderContactList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validatePolicyServiceRuleList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateRateScaleList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateSalaryMaintenanceRuleList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateServicerList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateSponsor(formats strfmt.Registry) error {
...
var policyDTOReqSystemBenefitListItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqSystemBenefitListItemsEnum = append(policyDTOReqSystemBenefitListItemsEnum, v)
	}
}

func (m *PolicyDTOReq) validateSystemBenefitListItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqSystemBenefitListItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateSystemBenefitList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateTpaContactList(formats strfmt.Registry) error {
...
var policyDTOReqTpaPackageListItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		policyDTOReqTpaPackageListItemsEnum = append(policyDTOReqTpaPackageListItemsEnum, v)
	}
}

func (m *PolicyDTOReq) validateTpaPackageListItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, policyDTOReqTpaPackageListItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PolicyDTOReq) validateTpaPackageList(formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) validateUnderWritingRuleList(formats strfmt.Registry) error {
...
// ContextValidate validate this policy d t o req based on the context it is used
func (m *PolicyDTOReq) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PolicyDTOReq) contextValidateAddressList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateAgentList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateAssociatedCompanyList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateBillGroupList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateBillingContactList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateCommissionRuleList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateCompensationEntityDTOList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateContact(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateEmailList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateExpenseRuleDTOList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateGroupOfficeList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateInstallStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateMemberGroupList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateNoteList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateOptionChoiceSet(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidatePhoneList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidatePolicyHolderContactList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidatePolicyServiceRuleList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateRateScaleList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateSalaryMaintenanceRuleList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateServicerList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateSponsor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateTpaContactList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) contextValidateUnderWritingRuleList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PolicyDTOReq) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PolicyDTOReq) UnmarshalBinary(b []byte) error {
	var res PolicyDTOReq
