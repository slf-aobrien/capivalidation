...
// ResponseWrapperPolicy ResponseWrapper«Policy»
//
// swagger:model ResponseWrapper«Policy»
type ResponseWrapperPolicy struct {
...
// Validate validates this response wrapper policy
func (m *ResponseWrapperPolicy) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPolicy) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicy) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicy) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper policy based on the context it is used
func (m *ResponseWrapperPolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPolicy) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicy) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicy) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicy) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperPolicy) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperPolicy
