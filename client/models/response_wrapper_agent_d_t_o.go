...
// ResponseWrapperAgentDTO ResponseWrapper«AgentDTO»
//
// swagger:model ResponseWrapper«AgentDTO»
type ResponseWrapperAgentDTO struct {
	...
	// payload
	Payload *AgentDTORes `json:"payload,omitempty"`
...
// Validate validates this response wrapper agent d t o
func (m *ResponseWrapperAgentDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAgentDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgentDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgentDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper agent d t o based on the context it is used
func (m *ResponseWrapperAgentDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAgentDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgentDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgentDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAgentDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperAgentDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperAgentDTO
