...
// ResponseWrapperListMemberGroupDTO ResponseWrapper«List«MemberGroupDTO»»
//
// swagger:model ResponseWrapper«List«MemberGroupDTO»»
type ResponseWrapperListMemberGroupDTO struct {
	...
	// payload
	Payload []*MemberGroupDTORes `json:"payload"`
...
// Validate validates this response wrapper list member group d t o
func (m *ResponseWrapperListMemberGroupDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListMemberGroupDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMemberGroupDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMemberGroupDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list member group d t o based on the context it is used
func (m *ResponseWrapperListMemberGroupDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListMemberGroupDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMemberGroupDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMemberGroupDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMemberGroupDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListMemberGroupDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListMemberGroupDTO
