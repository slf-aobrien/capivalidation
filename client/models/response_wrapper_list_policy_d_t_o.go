...
// ResponseWrapperListPolicyDTO ResponseWrapper«List«PolicyDTO»»
//
// swagger:model ResponseWrapper«List«PolicyDTO»»
type ResponseWrapperListPolicyDTO struct {
	...
	// payload
	Payload []*PolicyDTORes `json:"payload"`
...
// Validate validates this response wrapper list policy d t o
func (m *ResponseWrapperListPolicyDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPolicyDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPolicyDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPolicyDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list policy d t o based on the context it is used
func (m *ResponseWrapperListPolicyDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPolicyDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPolicyDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPolicyDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPolicyDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListPolicyDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListPolicyDTO
