...
// ResponseWrapperBillGroupDTO ResponseWrapper«BillGroupDTO»
//
// swagger:model ResponseWrapper«BillGroupDTO»
type ResponseWrapperBillGroupDTO struct {
	...
	// payload
	Payload *BillGroupDTORes `json:"payload,omitempty"`
...
// Validate validates this response wrapper bill group d t o
func (m *ResponseWrapperBillGroupDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBillGroupDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBillGroupDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBillGroupDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper bill group d t o based on the context it is used
func (m *ResponseWrapperBillGroupDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBillGroupDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBillGroupDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBillGroupDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBillGroupDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperBillGroupDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperBillGroupDTO
