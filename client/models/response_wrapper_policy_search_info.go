...
// ResponseWrapperPolicySearchInfo ResponseWrapper«PolicySearchInfo»
//
// swagger:model ResponseWrapper«PolicySearchInfo»
type ResponseWrapperPolicySearchInfo struct {
	...
	// payload
	Payload *PolicySearchInfo `json:"payload,omitempty"`
...
// Validate validates this response wrapper policy search info
func (m *ResponseWrapperPolicySearchInfo) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPolicySearchInfo) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicySearchInfo) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicySearchInfo) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper policy search info based on the context it is used
func (m *ResponseWrapperPolicySearchInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPolicySearchInfo) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicySearchInfo) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicySearchInfo) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPolicySearchInfo) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperPolicySearchInfo) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperPolicySearchInfo
