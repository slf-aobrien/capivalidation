...
// ResponseWrapperFundRateDetailDTO ResponseWrapper«FundRateDetailDTO»
//
// swagger:model ResponseWrapper«FundRateDetailDTO»
type ResponseWrapperFundRateDetailDTO struct {
	...
	// payload
	Payload *FundRateDetailDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper fund rate detail d t o
func (m *ResponseWrapperFundRateDetailDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperFundRateDetailDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperFundRateDetailDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperFundRateDetailDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper fund rate detail d t o based on the context it is used
func (m *ResponseWrapperFundRateDetailDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperFundRateDetailDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperFundRateDetailDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperFundRateDetailDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperFundRateDetailDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperFundRateDetailDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperFundRateDetailDTO
