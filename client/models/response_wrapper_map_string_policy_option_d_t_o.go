...
// ResponseWrapperMapStringPolicyOptionDTO ResponseWrapper«Map«string,PolicyOptionDTO»»
//
// swagger:model ResponseWrapper«Map«string,PolicyOptionDTO»»
type ResponseWrapperMapStringPolicyOptionDTO struct {
	...
	// payload
	Payload map[string]PolicyOptionDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper map string policy option d t o
func (m *ResponseWrapperMapStringPolicyOptionDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper map string policy option d t o based on the context it is used
func (m *ResponseWrapperMapStringPolicyOptionDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperMapStringPolicyOptionDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperMapStringPolicyOptionDTO
