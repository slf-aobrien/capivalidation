...
// ResponseWrapperListAEBFineosBeneInfo ResponseWrapper«List«AEBFineosBeneInfo»»
//
// swagger:model ResponseWrapper«List«AEBFineosBeneInfo»»
type ResponseWrapperListAEBFineosBeneInfo struct {
	...
	// payload
	Payload []*AEBFineosBeneInfo `json:"payload"`
...
// Validate validates this response wrapper list a e b fineos bene info
func (m *ResponseWrapperListAEBFineosBeneInfo) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAEBFineosBeneInfo) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAEBFineosBeneInfo) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAEBFineosBeneInfo) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list a e b fineos bene info based on the context it is used
func (m *ResponseWrapperListAEBFineosBeneInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAEBFineosBeneInfo) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAEBFineosBeneInfo) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAEBFineosBeneInfo) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAEBFineosBeneInfo) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListAEBFineosBeneInfo) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListAEBFineosBeneInfo
