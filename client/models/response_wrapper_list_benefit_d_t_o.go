...
// ResponseWrapperListBenefitDTO ResponseWrapper«List«BenefitDTO»»
//
// swagger:model ResponseWrapper«List«BenefitDTO»»
type ResponseWrapperListBenefitDTO struct {
	...
	// payload
	Payload []*BenefitDTORes `json:"payload"`
...
// Validate validates this response wrapper list benefit d t o
func (m *ResponseWrapperListBenefitDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBenefitDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBenefitDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBenefitDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list benefit d t o based on the context it is used
func (m *ResponseWrapperListBenefitDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBenefitDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBenefitDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBenefitDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBenefitDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBenefitDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBenefitDTO
