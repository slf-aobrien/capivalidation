...
// ResponseWrapperListAccreditationHistoryDTO ResponseWrapper«List«AccreditationHistoryDTO»»
//
// swagger:model ResponseWrapper«List«AccreditationHistoryDTO»»
type ResponseWrapperListAccreditationHistoryDTO struct {
	...
	// payload
	Payload []*AccreditationHistoryDTO `json:"payload"`
...
// Validate validates this response wrapper list accreditation history d t o
func (m *ResponseWrapperListAccreditationHistoryDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAccreditationHistoryDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAccreditationHistoryDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAccreditationHistoryDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list accreditation history d t o based on the context it is used
func (m *ResponseWrapperListAccreditationHistoryDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAccreditationHistoryDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAccreditationHistoryDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAccreditationHistoryDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAccreditationHistoryDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListAccreditationHistoryDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListAccreditationHistoryDTO
