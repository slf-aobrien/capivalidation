...
// ResponseWrapperVarianceDTO ResponseWrapper«VarianceDTO»
//
// swagger:model ResponseWrapper«VarianceDTO»
type ResponseWrapperVarianceDTO struct {
	...
	// payload
	Payload *VarianceDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper variance d t o
func (m *ResponseWrapperVarianceDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperVarianceDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperVarianceDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperVarianceDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper variance d t o based on the context it is used
func (m *ResponseWrapperVarianceDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperVarianceDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperVarianceDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperVarianceDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperVarianceDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperVarianceDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperVarianceDTO
