...
// ResponseWrapperListVarianceDetailDTO ResponseWrapper«List«VarianceDetailDTO»»
//
// swagger:model ResponseWrapper«List«VarianceDetailDTO»»
type ResponseWrapperListVarianceDetailDTO struct {
	...
	// payload
	Payload []*VarianceDetailDTO `json:"payload"`
...
// Validate validates this response wrapper list variance detail d t o
func (m *ResponseWrapperListVarianceDetailDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListVarianceDetailDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListVarianceDetailDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListVarianceDetailDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list variance detail d t o based on the context it is used
func (m *ResponseWrapperListVarianceDetailDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListVarianceDetailDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListVarianceDetailDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListVarianceDetailDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListVarianceDetailDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListVarianceDetailDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListVarianceDetailDTO
