...
// ResponseWrapperAuditTPACellBillDTO ResponseWrapper«AuditTPACellBillDTO»
//
// swagger:model ResponseWrapper«AuditTPACellBillDTO»
type ResponseWrapperAuditTPACellBillDTO struct {
	...
	// payload
	Payload *AuditTPACellBillDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper audit t p a cell bill d t o
func (m *ResponseWrapperAuditTPACellBillDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAuditTPACellBillDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAuditTPACellBillDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperAuditTPACellBillDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper audit t p a cell bill d t o based on the context it is used
func (m *ResponseWrapperAuditTPACellBillDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperAuditTPACellBillDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAuditTPACellBillDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAuditTPACellBillDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperAuditTPACellBillDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperAuditTPACellBillDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperAuditTPACellBillDTO
