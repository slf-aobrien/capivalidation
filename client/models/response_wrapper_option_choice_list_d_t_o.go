...
// ResponseWrapperOptionChoiceListDTO ResponseWrapper«OptionChoiceListDTO»
//
// swagger:model ResponseWrapper«OptionChoiceListDTO»
type ResponseWrapperOptionChoiceListDTO struct {
	...
	// payload
	Payload *OptionChoiceListDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper option choice list d t o
func (m *ResponseWrapperOptionChoiceListDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperOptionChoiceListDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperOptionChoiceListDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperOptionChoiceListDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper option choice list d t o based on the context it is used
func (m *ResponseWrapperOptionChoiceListDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperOptionChoiceListDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperOptionChoiceListDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperOptionChoiceListDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperOptionChoiceListDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperOptionChoiceListDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperOptionChoiceListDTO
