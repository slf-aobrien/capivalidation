...
// ResponseWrapperListAgencyDTO ResponseWrapper«List«AgencyDTO»»
//
// swagger:model ResponseWrapper«List«AgencyDTO»»
type ResponseWrapperListAgencyDTO struct {
	...
	// payload
	Payload []*AgencyDTORes `json:"payload"`
...
// Validate validates this response wrapper list agency d t o
func (m *ResponseWrapperListAgencyDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAgencyDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgencyDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgencyDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list agency d t o based on the context it is used
func (m *ResponseWrapperListAgencyDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAgencyDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgencyDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgencyDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgencyDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListAgencyDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListAgencyDTO
