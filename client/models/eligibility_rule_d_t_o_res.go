...
// EligibilityRuleDTORes EligibilityRuleDTORes
//
// swagger:model EligibilityRuleDTORes
type EligibilityRuleDTORes struct {
...
// Validate validates this eligibility rule d t o res
func (m *EligibilityRuleDTORes) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EligibilityRuleDTORes) validateFutureServiceRequirement(formats strfmt.Registry) error {
...
func (m *EligibilityRuleDTORes) validateIssueServiceRequirement(formats strfmt.Registry) error {
...
func (m *EligibilityRuleDTORes) validatePediatric(formats strfmt.Registry) error {
...
// ContextValidate validate this eligibility rule d t o res based on the context it is used
func (m *EligibilityRuleDTORes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *EligibilityRuleDTORes) contextValidateFutureServiceRequirement(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EligibilityRuleDTORes) contextValidateIssueServiceRequirement(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EligibilityRuleDTORes) contextValidatePediatric(ctx context.Context, formats strfmt.Registry) error {
...
func (m *EligibilityRuleDTORes) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *EligibilityRuleDTORes) UnmarshalBinary(b []byte) error {
	var res EligibilityRuleDTORes
