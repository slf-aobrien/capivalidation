...
// ResponseWrapperListCaseBillDTO ResponseWrapper«List«CaseBillDTO»»
//
// swagger:model ResponseWrapper«List«CaseBillDTO»»
type ResponseWrapperListCaseBillDTO struct {
	...
	// payload
	Payload []*CaseBillDTO `json:"payload"`
...
// Validate validates this response wrapper list case bill d t o
func (m *ResponseWrapperListCaseBillDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListCaseBillDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCaseBillDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCaseBillDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list case bill d t o based on the context it is used
func (m *ResponseWrapperListCaseBillDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListCaseBillDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCaseBillDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCaseBillDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCaseBillDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListCaseBillDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListCaseBillDTO
