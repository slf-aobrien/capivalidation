...
// ResponseWrapperListAgentDTO ResponseWrapper«List«AgentDTO»»
//
// swagger:model ResponseWrapper«List«AgentDTO»»
type ResponseWrapperListAgentDTO struct {
	...
	// payload
	Payload []*AgentDTORes `json:"payload"`
...
// Validate validates this response wrapper list agent d t o
func (m *ResponseWrapperListAgentDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAgentDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgentDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgentDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list agent d t o based on the context it is used
func (m *ResponseWrapperListAgentDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListAgentDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgentDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgentDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListAgentDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListAgentDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListAgentDTO
