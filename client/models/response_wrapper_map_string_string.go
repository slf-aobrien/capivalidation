...
func (m *ResponseWrapperMapStringString) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringString) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper map string string based on the context it is used
...
func (m *ResponseWrapperMapStringString) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMapStringString) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
