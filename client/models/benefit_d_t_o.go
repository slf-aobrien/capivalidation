...
type BenefitDTO struct {
	...
	// eligibility rule
	EligibilityRule *EligibilityRuleDTO `json:"eligibilityRule,omitempty"`
...
// Validate validates this benefit d t o
func (m *BenefitDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BenefitDTO) validateBenefitFeature(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateBenefitTranchList(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateCoverageGrouping(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateEligibilityRule(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateIssueAgeList(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateMemberBenefitOptionList(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateMoneyTypeList(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validatePossibleOptionChoiceList(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validatePremiumDetailList(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateRiskRule(formats strfmt.Registry) error {
...
func (m *BenefitDTO) validateSelectionAmountSet(formats strfmt.Registry) error {
...
// ContextValidate validate this benefit d t o based on the context it is used
func (m *BenefitDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BenefitDTO) contextValidateBenefitFeature(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateBenefitTranchList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateCoverageGrouping(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateEligibilityRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateIssueAgeList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateMemberBenefitOptionList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateMoneyTypeList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidatePossibleOptionChoiceList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidatePremiumDetailList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) contextValidateRiskRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BenefitDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BenefitDTO) UnmarshalBinary(b []byte) error {
	var res BenefitDTO
