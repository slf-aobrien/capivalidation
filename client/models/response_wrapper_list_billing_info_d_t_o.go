...
// ResponseWrapperListBillingInfoDTO ResponseWrapper«List«BillingInfoDTO»»
//
// swagger:model ResponseWrapper«List«BillingInfoDTO»»
type ResponseWrapperListBillingInfoDTO struct {
	...
	// payload
	Payload []*BillingInfoDTO `json:"payload"`
...
// Validate validates this response wrapper list billing info d t o
func (m *ResponseWrapperListBillingInfoDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillingInfoDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillingInfoDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillingInfoDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list billing info d t o based on the context it is used
func (m *ResponseWrapperListBillingInfoDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillingInfoDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillingInfoDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillingInfoDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillingInfoDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBillingInfoDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBillingInfoDTO
