...
// ResponseWrapperBenefitDTO ResponseWrapper«BenefitDTO»
//
// swagger:model ResponseWrapper«BenefitDTO»
type ResponseWrapperBenefitDTO struct {
	...
	// payload
	Payload *BenefitDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper benefit d t o
func (m *ResponseWrapperBenefitDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBenefitDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBenefitDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBenefitDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper benefit d t o based on the context it is used
func (m *ResponseWrapperBenefitDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBenefitDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBenefitDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBenefitDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBenefitDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperBenefitDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperBenefitDTO
