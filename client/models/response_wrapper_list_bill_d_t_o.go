...
// ResponseWrapperListBillDTO ResponseWrapper«List«BillDTO»»
//
// swagger:model ResponseWrapper«List«BillDTO»»
type ResponseWrapperListBillDTO struct {
...
// Validate validates this response wrapper list bill d t o
func (m *ResponseWrapperListBillDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list bill d t o based on the context it is used
func (m *ResponseWrapperListBillDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBillDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBillDTO
