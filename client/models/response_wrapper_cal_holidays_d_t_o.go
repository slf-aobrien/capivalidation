...
// ResponseWrapperCalHolidaysDTO ResponseWrapper«CalHolidaysDTO»
//
// swagger:model ResponseWrapper«CalHolidaysDTO»
type ResponseWrapperCalHolidaysDTO struct {
	...
	// payload
	Payload *CalHolidaysDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper cal holidays d t o
func (m *ResponseWrapperCalHolidaysDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperCalHolidaysDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperCalHolidaysDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperCalHolidaysDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper cal holidays d t o based on the context it is used
func (m *ResponseWrapperCalHolidaysDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperCalHolidaysDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperCalHolidaysDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperCalHolidaysDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperCalHolidaysDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperCalHolidaysDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperCalHolidaysDTO
