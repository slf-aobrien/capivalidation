...
// BillGroupRuleDTORes BillGroupRuleDTORes
//
// swagger:model BillGroupRuleDTORes
type BillGroupRuleDTORes struct {
...
// Validate validates this bill group rule d t o res
func (m *BillGroupRuleDTORes) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BillGroupRuleDTORes) validateAddress(formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) validateContact(formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) validateEmail(formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) validateFax(formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) validatePhone(formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) validateTransactionScheduler(formats strfmt.Registry) error {
...
// ContextValidate validate this bill group rule d t o res based on the context it is used
func (m *BillGroupRuleDTORes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BillGroupRuleDTORes) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) contextValidateContact(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) contextValidateEmail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) contextValidateFax(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) contextValidatePhone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) contextValidateTransactionScheduler(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BillGroupRuleDTORes) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BillGroupRuleDTORes) UnmarshalBinary(b []byte) error {
	var res BillGroupRuleDTORes
