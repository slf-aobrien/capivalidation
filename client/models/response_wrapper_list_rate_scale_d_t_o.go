...
// ResponseWrapperListRateScaleDTO ResponseWrapper«List«RateScaleDTO»»
//
// swagger:model ResponseWrapper«List«RateScaleDTO»»
type ResponseWrapperListRateScaleDTO struct {
	...
	// payload
	Payload []*RateScaleDTO `json:"payload"`
...
// Validate validates this response wrapper list rate scale d t o
func (m *ResponseWrapperListRateScaleDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListRateScaleDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListRateScaleDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListRateScaleDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list rate scale d t o based on the context it is used
func (m *ResponseWrapperListRateScaleDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListRateScaleDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListRateScaleDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListRateScaleDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListRateScaleDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListRateScaleDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListRateScaleDTO
