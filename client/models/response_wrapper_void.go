...
// ResponseWrapperVoid ResponseWrapper«Void»
//
// swagger:model ResponseWrapper«Void»
type ResponseWrapperVoid struct {
...
// Validate validates this response wrapper void
func (m *ResponseWrapperVoid) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperVoid) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperVoid) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper void based on the context it is used
func (m *ResponseWrapperVoid) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperVoid) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperVoid) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperVoid) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperVoid) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperVoid
