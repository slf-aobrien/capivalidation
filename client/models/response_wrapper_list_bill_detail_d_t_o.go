...
// ResponseWrapperListBillDetailDTO ResponseWrapper«List«BillDetailDTO»»
//
// swagger:model ResponseWrapper«List«BillDetailDTO»»
type ResponseWrapperListBillDetailDTO struct {
	...
	// payload
	Payload []*BillDetailDTO `json:"payload"`
...
// Validate validates this response wrapper list bill detail d t o
func (m *ResponseWrapperListBillDetailDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillDetailDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDetailDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDetailDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list bill detail d t o based on the context it is used
func (m *ResponseWrapperListBillDetailDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillDetailDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDetailDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDetailDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillDetailDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBillDetailDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBillDetailDTO
