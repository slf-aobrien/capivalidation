...
// ResponseWrapperListBillGroupDTO ResponseWrapper«List«BillGroupDTO»»
//
// swagger:model ResponseWrapper«List«BillGroupDTO»»
type ResponseWrapperListBillGroupDTO struct {
	...
	// payload
	Payload []*BillGroupDTORes `json:"payload"`
...
// Validate validates this response wrapper list bill group d t o
func (m *ResponseWrapperListBillGroupDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillGroupDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillGroupDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillGroupDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list bill group d t o based on the context it is used
func (m *ResponseWrapperListBillGroupDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillGroupDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillGroupDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillGroupDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillGroupDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBillGroupDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBillGroupDTO
