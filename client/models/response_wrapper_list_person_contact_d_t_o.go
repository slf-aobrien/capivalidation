...
// ResponseWrapperListPersonContactDTO ResponseWrapper«List«PersonContactDTO»»
//
// swagger:model ResponseWrapper«List«PersonContactDTO»»
type ResponseWrapperListPersonContactDTO struct {
	...
	// payload
	Payload []*PersonContactDTO `json:"payload"`
...
// Validate validates this response wrapper list person contact d t o
func (m *ResponseWrapperListPersonContactDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPersonContactDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonContactDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonContactDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list person contact d t o based on the context it is used
func (m *ResponseWrapperListPersonContactDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPersonContactDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonContactDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonContactDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPersonContactDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListPersonContactDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListPersonContactDTO
