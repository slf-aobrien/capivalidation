...
// ResponseWrapperMemberBenefitOptionDTO ResponseWrapper«MemberBenefitOptionDTO»
//
// swagger:model ResponseWrapper«MemberBenefitOptionDTO»
type ResponseWrapperMemberBenefitOptionDTO struct {
	...
	// payload
	Payload *MemberBenefitOptionDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper member benefit option d t o
func (m *ResponseWrapperMemberBenefitOptionDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMemberBenefitOptionDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberBenefitOptionDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberBenefitOptionDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper member benefit option d t o based on the context it is used
func (m *ResponseWrapperMemberBenefitOptionDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMemberBenefitOptionDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberBenefitOptionDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberBenefitOptionDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberBenefitOptionDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperMemberBenefitOptionDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperMemberBenefitOptionDTO
