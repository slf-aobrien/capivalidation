...
// ResponseWrapperDomainDTO ResponseWrapper«DomainDTO»
//
// swagger:model ResponseWrapper«DomainDTO»
type ResponseWrapperDomainDTO struct {
	...
	// payload
	Payload *DomainDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper domain d t o
func (m *ResponseWrapperDomainDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperDomainDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperDomainDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperDomainDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper domain d t o based on the context it is used
func (m *ResponseWrapperDomainDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperDomainDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDomainDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDomainDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDomainDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperDomainDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperDomainDTO
