...
// ResponseWrapperTraditionalBillPageDTO ResponseWrapper«TraditionalBillPageDTO»
//
// swagger:model ResponseWrapper«TraditionalBillPageDTO»
type ResponseWrapperTraditionalBillPageDTO struct {
	...
	// payload
	Payload *TraditionalBillPageDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper traditional bill page d t o
func (m *ResponseWrapperTraditionalBillPageDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTraditionalBillPageDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTraditionalBillPageDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperTraditionalBillPageDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper traditional bill page d t o based on the context it is used
func (m *ResponseWrapperTraditionalBillPageDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperTraditionalBillPageDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperTraditionalBillPageDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperTraditionalBillPageDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperTraditionalBillPageDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperTraditionalBillPageDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperTraditionalBillPageDTO
