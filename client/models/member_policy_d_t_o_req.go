...
// MemberPolicyDTOReq MemberPolicyDTOReq
//
// swagger:model MemberPolicyDTOReq
type MemberPolicyDTOReq struct {

	// benefit list
	BenefitList []*BenefitDTOReq `json:"benefitList"`

	// bill group
	BillGroup *BillGroupDTOReq `json:"billGroup,omitempty"`
	...
	// dependent list
	DependentList []*DependentDTOReq `json:"dependentList"`
	...
	// member group
	MemberGroup *MemberGroupDTOReq `json:"memberGroup,omitempty"`
	...
	// policy
	Policy *PolicyDTOReq `json:"policy,omitempty"`
...
// Validate validates this member policy d t o req
func (m *MemberPolicyDTOReq) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MemberPolicyDTOReq) validateBenefitList(formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) validateBillGroup(formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) validateDepartmentDetails(formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) validateDependentList(formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) validateMemberGroup(formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) validatePolicy(formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) validateSalary(formats strfmt.Registry) error {
...
// ContextValidate validate this member policy d t o req based on the context it is used
func (m *MemberPolicyDTOReq) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MemberPolicyDTOReq) contextValidateBenefitList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) contextValidateBillGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) contextValidateDepartmentDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) contextValidateDependentList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) contextValidateMemberGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) contextValidatePolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) contextValidateSalary(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MemberPolicyDTOReq) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MemberPolicyDTOReq) UnmarshalBinary(b []byte) error {
	var res MemberPolicyDTOReq
