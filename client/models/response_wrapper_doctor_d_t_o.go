...
// ResponseWrapperDoctorDTO ResponseWrapper«DoctorDTO»
//
// swagger:model ResponseWrapper«DoctorDTO»
type ResponseWrapperDoctorDTO struct {
	...
	// payload
	Payload *DoctorDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper doctor d t o
func (m *ResponseWrapperDoctorDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperDoctorDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperDoctorDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperDoctorDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper doctor d t o based on the context it is used
func (m *ResponseWrapperDoctorDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperDoctorDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDoctorDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDoctorDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperDoctorDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperDoctorDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperDoctorDTO
