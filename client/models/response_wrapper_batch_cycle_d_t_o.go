...
// ResponseWrapperBatchCycleDTO ResponseWrapper«BatchCycleDTO»
//
// swagger:model ResponseWrapper«BatchCycleDTO»
type ResponseWrapperBatchCycleDTO struct {
	...
	// payload
	Payload *BatchCycleDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper batch cycle d t o
func (m *ResponseWrapperBatchCycleDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBatchCycleDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBatchCycleDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperBatchCycleDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper batch cycle d t o based on the context it is used
func (m *ResponseWrapperBatchCycleDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperBatchCycleDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBatchCycleDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBatchCycleDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperBatchCycleDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperBatchCycleDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperBatchCycleDTO
