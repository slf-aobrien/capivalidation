...
// ResponseWrapperMemberDTO ResponseWrapper«MemberDTO»
//
// swagger:model ResponseWrapper«MemberDTO»
type ResponseWrapperMemberDTO struct {
	...
	// payload
	Payload *MemberDTORes `json:"payload,omitempty"`
...
// Validate validates this response wrapper member d t o
func (m *ResponseWrapperMemberDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMemberDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper member d t o based on the context it is used
func (m *ResponseWrapperMemberDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperMemberDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperMemberDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperMemberDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperMemberDTO
