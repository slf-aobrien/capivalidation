...
// ResponseWrapperListBillSummaryDTO ResponseWrapper«List«BillSummaryDTO»»
//
// swagger:model ResponseWrapper«List«BillSummaryDTO»»
type ResponseWrapperListBillSummaryDTO struct {
	...
	// payload
	Payload []*BillSummaryDTO `json:"payload"`
...
// Validate validates this response wrapper list bill summary d t o
func (m *ResponseWrapperListBillSummaryDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillSummaryDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillSummaryDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillSummaryDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list bill summary d t o based on the context it is used
func (m *ResponseWrapperListBillSummaryDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListBillSummaryDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillSummaryDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillSummaryDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListBillSummaryDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListBillSummaryDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListBillSummaryDTO
