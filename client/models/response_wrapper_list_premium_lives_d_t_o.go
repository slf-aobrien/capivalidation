...
// ResponseWrapperListPremiumLivesDTO ResponseWrapper«List«PremiumLivesDTO»»
//
// swagger:model ResponseWrapper«List«PremiumLivesDTO»»
type ResponseWrapperListPremiumLivesDTO struct {
	...
	// payload
	Payload []*PremiumLivesDTO `json:"payload"`
...
// Validate validates this response wrapper list premium lives d t o
func (m *ResponseWrapperListPremiumLivesDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPremiumLivesDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPremiumLivesDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPremiumLivesDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list premium lives d t o based on the context it is used
func (m *ResponseWrapperListPremiumLivesDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListPremiumLivesDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPremiumLivesDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPremiumLivesDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListPremiumLivesDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListPremiumLivesDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListPremiumLivesDTO
