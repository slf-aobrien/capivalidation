...
// ResponseWrapperPersonContactDTO ResponseWrapper«PersonContactDTO»
//
// swagger:model ResponseWrapper«PersonContactDTO»
type ResponseWrapperPersonContactDTO struct {
	...
	// payload
	Payload *PersonContactDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper person contact d t o
func (m *ResponseWrapperPersonContactDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPersonContactDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPersonContactDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperPersonContactDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper person contact d t o based on the context it is used
func (m *ResponseWrapperPersonContactDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperPersonContactDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPersonContactDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPersonContactDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperPersonContactDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperPersonContactDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperPersonContactDTO
