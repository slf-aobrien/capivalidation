...
// AgentDTORes AgentDTORes
//
// swagger:model AgentDTORes
type AgentDTORes struct {
...
// Validate validates this agent d t o res
func (m *AgentDTORes) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AgentDTORes) validateAccreditationHistoryList(formats strfmt.Registry) error {
...
func (m *AgentDTORes) validateAddress(formats strfmt.Registry) error {
...
func (m *AgentDTORes) validateAgentIDList(formats strfmt.Registry) error {
...
func (m *AgentDTORes) validateEmail(formats strfmt.Registry) error {
...
func (m *AgentDTORes) validateOrganization(formats strfmt.Registry) error {
...
func (m *AgentDTORes) validatePerson(formats strfmt.Registry) error {
...
func (m *AgentDTORes) validatePhone(formats strfmt.Registry) error {
...
// ContextValidate validate this agent d t o res based on the context it is used
func (m *AgentDTORes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AgentDTORes) contextValidateAccreditationHistoryList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) contextValidateAddress(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) contextValidateAgentIDList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) contextValidateEmail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) contextValidateOrganization(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) contextValidatePerson(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) contextValidatePhone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AgentDTORes) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AgentDTORes) UnmarshalBinary(b []byte) error {
	var res AgentDTORes
