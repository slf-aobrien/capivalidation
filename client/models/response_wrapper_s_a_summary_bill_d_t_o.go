...
// ResponseWrapperSASummaryBillDTO ResponseWrapper«SASummaryBillDTO»
//
// swagger:model ResponseWrapper«SASummaryBillDTO»
type ResponseWrapperSASummaryBillDTO struct {
	...
	// payload
	Payload *SASummaryBillDTO `json:"payload,omitempty"`
...
// Validate validates this response wrapper s a summary bill d t o
func (m *ResponseWrapperSASummaryBillDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperSASummaryBillDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperSASummaryBillDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperSASummaryBillDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper s a summary bill d t o based on the context it is used
func (m *ResponseWrapperSASummaryBillDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperSASummaryBillDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperSASummaryBillDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperSASummaryBillDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperSASummaryBillDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperSASummaryBillDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperSASummaryBillDTO
