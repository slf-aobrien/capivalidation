...
// ResponseWrapperListMbrEligDataDTO ResponseWrapper«List«MbrEligDataDTO»»
//
// swagger:model ResponseWrapper«List«MbrEligDataDTO»»
type ResponseWrapperListMbrEligDataDTO struct {
	...
	// payload
	Payload []*MbrEligDataDTO `json:"payload"`
...
// Validate validates this response wrapper list mbr elig data d t o
func (m *ResponseWrapperListMbrEligDataDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListMbrEligDataDTO) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMbrEligDataDTO) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMbrEligDataDTO) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list mbr elig data d t o based on the context it is used
func (m *ResponseWrapperListMbrEligDataDTO) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListMbrEligDataDTO) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMbrEligDataDTO) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMbrEligDataDTO) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListMbrEligDataDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListMbrEligDataDTO) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListMbrEligDataDTO
