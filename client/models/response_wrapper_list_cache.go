...
// ResponseWrapperListCache ResponseWrapper«List«Cache»»
//
// swagger:model ResponseWrapper«List«Cache»»
type ResponseWrapperListCache struct {
...
// Validate validates this response wrapper list cache
func (m *ResponseWrapperListCache) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListCache) validatePayload(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCache) validateVarianceDetailMap(formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCache) validateVarianceMap(formats strfmt.Registry) error {
...
// ContextValidate validate this response wrapper list cache based on the context it is used
func (m *ResponseWrapperListCache) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseWrapperListCache) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCache) contextValidateVarianceDetailMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCache) contextValidateVarianceMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResponseWrapperListCache) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ResponseWrapperListCache) UnmarshalBinary(b []byte) error {
	var res ResponseWrapperListCache
